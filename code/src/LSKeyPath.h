...
public:
    ...
    static void MarkKeyNodes(Graph &g, SteinerSolution &solution, UniverseSet &keynodes, bool terminals) {
        ...
        static int KeyVertexElimination (Graph &g, SteinerSolution &solution) {
			...
			//return 0;
            return KeyVertexElimination(g, solution, data, vdata, true, true);
        }
        ...
        static int KeyVertexElimination (Graph &g, SteinerSolution &solution, KeyPathData &data, KeyVertexData &vdata, bool allow_paths, bool allow_vertices) {
